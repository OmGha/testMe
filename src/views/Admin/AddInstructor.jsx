...
class AddInstructor extends React.Component {
    ...
    const { classes } = this.props;
      return (
        ...
        <p style={{ textAlign: "center"}}>
            <h2 className={classes.cardTitle }>Add a New Instructor</h2>
        </p>
        ...
        <GridContainer>
            ...
            <GridItem style={{textAlign: "center", margin: "20px 0 0 0"}} xs={12} sm={12} md={12}>
                <Button style={{textAlign: "center"}} type="button" round color="success" size="md" >Submit Instructor</Button>
            </GridItem>
        </GridContainer>
        </CardBody>
      </Card>
  ...
  export default withStyles(styles)(AddInstructor);